...
import ChatLogin.LoginController;
import ChatLogin.LoginModel;
import ChatLogin.LoginView;
import appView.App_View;
...
public class ChatApplication extends Application {
    private static ChatApplication mainProgram; // singleton
    ...
    public void startLogin() {
        ...
        LoginView view = new LoginView(loginStage, model);
        new LoginController(this, model, view);
        ...
        view.start();
        serviceLocator.getLogger().info("Login View started");
    }
    ...
    protected static ChatApplication getMainProgram() {
        return mainProgram;
    }
}
